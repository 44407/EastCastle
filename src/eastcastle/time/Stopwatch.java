...
/**
 * <p>
 * Stopwatch functionality interface. Using this interface is preferred over
 * using concrete implementations, though there is a very small performance
 * penalty involved.
 * </p>
 *
 * <p>
 * Applications that require extreme performance may consider using a concrete
 * implementation directly.
 * </p>
 *
 * <p>
 * By convention, concrete insantiations of this class are running upon creation
 * with a start time equal to the instantiation time.
 * </p>
 *
 * <p>
 * Elapsed time is defined as elapsed time = stop time - start time. This is
 * only defined when the state is stopped.
 * </p>
 *
 * <p>
 * Split time is defined as split time = current time - start time.
 * </p>
 */
public interface Stopwatch {
   ...
   /**
    * Set the start time to the current time, and start running. Must be stopped
    * when calling this method.
    */
   public void start();

   /**
    * Set the stop time to the current time, and stop running. Must be running when
    * calling this method.
    */
   public void stop();
   ...
   /**
    * Get the elapsed StopWatch time in nanoseconds. Must be stopped when calling
    * this method.
    *
   ...
   /**
    * Get the elapsed StopWatch time in milliseconds (as a long.) Must be stopped
    * when calling this method.
    *
   ...
   /**
    * Get the elapsed StopWatch time in milliseconds. Must be stopped when calling
    * this method.
    *
   ...
   /**
    * Get the elapsed StopWatch time in seconds. Must be stopped when calling this
    * method.
    *
   ...
   /**
    * Get the elapsed StopWatch time in seconds (as a BigDecimal.) Must be stopped
    * when calling this method.
    *
