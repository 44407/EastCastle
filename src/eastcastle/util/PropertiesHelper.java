...
import eastcastle.text.StringUtil;
...
public class PropertiesHelper {
   ...
   public enum LogMode {
      Silent, Exceptions, UndefinedAndExceptions
   };

   public enum ParseExceptionAction {
      DefaultOnParseException, RethrowParseException
   };

   public enum UndefinedAction {
      DefaultOnUndefined, ExceptionOnUndefined, ZeroOnUndefined
   };
   ...
   private void logDefaultOnUndefined(String name, Object defaultValue) {
      if (logMode == LogMode.UndefinedAndExceptions) {
         // Log.warning("Property undefined, using default: " + name + " = " +
         // defaultValue);
      }
   }
   ...
   private void logDefaultOnParseException(String name, Object defaultValue) {
      if (logMode != LogMode.Silent) {
         // Log.warning("Property can't be parsed, using default: " + name + " = " +
         // defaultValue);
      }
   }
   ...
   public int getInt(String name, int defaultValue) {
      return getInt(name, defaultValue, UndefinedAction.DefaultOnUndefined,
